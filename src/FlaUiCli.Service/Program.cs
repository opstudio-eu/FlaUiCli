...
namespace FlaUiCli.Service;

public class Program
{
    private static readonly AutomationService _automationService = new();
    ...
    private static async Task CheckIdleTimeout()
    {
    ...
    private static async Task HandleClient(NamedPipeServerStream server)
    {
        try
        {
            ...
            if (request == null)
            {
                await SendResponse(server, new IpcResponse 
                { 
                    Success = false, 
            ...
            await SendResponse(server, response);
        }
        catch (Exception ex)
        {
            await SendResponse(server, new IpcResponse
    ...
    private static async Task SendResponse(NamedPipeServerStream server, IpcResponse response)
    {
    ...
    private static IpcResponse ProcessCommand(IpcRequest request)
    {
        try
        {
    ...
    private static object? Connect(Dictionary<string, object?> args)
    {
    ...
    private static object? FocusWindow(Dictionary<string, object?> args)
    {
    ...
    private static object? GetElementTree(Dictionary<string, object?> args)
    {
        var depth = 5;
    ...
    private static object? FindElements(Dictionary<string, object?> args)
    {
    ...
    private static object? GetElementInfo(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
        return _automationService.GetElement(id);
    }

    private static object? Click(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? RightClick(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? DoubleClick(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? TypeText(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? ClearText(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? PressKey(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? SetCheck(Dictionary<string, object?> args, bool check)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? Toggle(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? Select(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? Expand(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? Collapse(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? Invoke(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
    ...
    private static object? GetText(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
        return new { text = _automationService.GetText(id) };
    }

    private static object? GetValue(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
        return new { value = _automationService.GetValue(id) };
    }

    private static object? GetState(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
        return _automationService.GetState(id);
    }

    private static object? GetPatterns(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
        return new { patterns = _automationService.GetPatterns(id) };
    }

    private static object? WaitForElement(Dictionary<string, object?> args)
    {
        var criteria = new QueryCriteria
        {
            AutomationId = GetOptionalStringArg(args, "aid"),
    ...
    private static object? WaitForGone(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
        var timeout = GetOptionalArg(args, "timeout", 5000);
    ...
    private static object? WaitForEnabled(Dictionary<string, object?> args)
    {
        var id = GetRequiredArg<string>(args, "id");
        var timeout = GetOptionalArg(args, "timeout", 5000);
    ...
    private static object? TakeScreenshotBase64(Dictionary<string, object?> args)
    {
        var elementId = GetOptionalStringArg(args, "elementId");
